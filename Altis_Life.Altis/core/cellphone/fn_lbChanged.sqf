...
if (_data == "Não Tens mensagens.") then 
{
    _text ctrlSetText "Não Tens mensagens.";
} 
else
{
    ...
    _text ctrlSetText format ["""%1"" - %2 \n \nMensagem recebida as %6:%7 em %3/%4/%5 . ", _message, _nameOnPList, _day, _month, _year, _hour, _minutes];
