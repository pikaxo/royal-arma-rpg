...
private ["_control","_index","_className","_classNameLife","_dataArr","_vehicleColor","_vehicleInfo","_trunkSpace","_sellPrice","_retrievePrice","_sellMultiplier","_insurance","_insuranceMultiplier","_price","_storageFee","_purchasePrice"];
...
(CONTROL(2800,2803)) ctrlSetStructuredText parseText format [
    ...
    Preço do Seguro: <t color='#8cff9b'>$%9</t><br/>
    Estado do Seguro: %10 <br/>
...
if(_insurance == 1) then {"<t color='#8cff9b'>Assegurado</t>"} else {"<t color='#FF0000'>Não Assegurado</t>"},
