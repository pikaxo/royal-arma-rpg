...
class WeaponShops {
    ...
    class cop_basic {
        ...
        items[] = {
            ...
            { "srifle_GM6_camo_F", "", 30000, 15000, "call life_coplevel >= 6" },
        ...
        mags[] = {
            ...
            { "5Rnd_127x108_Mag", "", 500, 15000, "call life_coplevel >= 6" },
            { "5Rnd_127x108_APDS_Mag", "", 1000, 15000, "call life_coplevel >= 6" },
        ...
        accs[] = {
            ...
            { "optic_Nightstalker", "", 10000, 15000, "call life_coplevel >= 6" },
