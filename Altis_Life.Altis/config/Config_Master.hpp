...
/* System Settings */
    ...
    crimes[] = {
        {"STR_Crime_187V","2500","187V"}, //atropelamento
        {"STR_Crime_187","5000","187"}, //homicidio involuntario
        {"STR_Crime_901","50000","901"}, //fuga da prisao********************
        {"STR_Crime_215","1000","215"}, //tentativa furto de carro
        {"STR_Crime_213","100000","213"}, //explosivos ilegais
        {"STR_Crime_211","1000","211"}, //roubo*******************************
        {"STR_Crime_207","25000","207"}, //squestro
        {"STR_Crime_207A","12500","207A"}, //tentativa de sequestro
        {"STR_Crime_390","3000","390"},  //uso de drogas em publico
        {"STR_Crime_487","150","487"},  //grande roubo
        {"STR_Crime_488","70","488"},  //pequeno roubo
        {"STR_Crime_480","100","480"},  //bate e foge
        {"STR_Crime_481","100","481"},  //posse de droga
        {"STR_Crime_482","500","482"},  //tentiva de trafico
        {"STR_Crime_483","950","483"},  //Porte de drogas
        {"STR_Crime_459","650","459"},  //arrombamento
        {"STR_Crime_666","200","666"},  //evasao fiscal
        {"STR_Crime_667","4500","667"},  //terrorismo
        {"STR_Crime_668","1500","668"},  //caça sem licença
        {"STR_Crime_1","250","1"},  //dirigir sem licença
        {"STR_Crime_2","200","2"},  //dirigir no sentido oposto
        {"STR_Crime_3","150","3"},  //nao respeitar as sinalisaçoes
        {"STR_Crime_4","250","4"},  // execo de velocidade
        {"STR_Crime_5","100","5"},  //luzes apagadas durante a noite
        {"STR_Crime_6","80","6"},  //dirigir kart sem capacete
        {"STR_Crime_7","150","7"},  //carro mal estacionado
        {"STR_Crime_8","5000","8"},  //carro revelde nao armado
        {"STR_Crime_9","5000","9"},  // roubo de carro civil
        {"STR_Crime_10","15000","10"},  //roubo de carro militar
        {"STR_Crime_11","10000","11"},  //carro revelde armado
        {"STR_Crime_12","2500","12"},  //voar as cidades sem autorizaçao
        {"STR_Crime_13","1500","13"},  //fechar a rua sem autorizaçao
        {"STR_Crime_14","500","14"},  //portar arma legal em cidade
        {"STR_Crime_15","2500","15"},  //arma revelde
        {"STR_Crime_16","1500","16"},  //roupas ilegais
        {"STR_Crime_17","100","17"},  //esconder o rosto"mascara/gillie"
        {"STR_Crime_18","1500","18"},  //recusar-se a cooperar
        {"STR_Crime_19","2500","19"},  //atropelamento e fuga
        {"STR_Crime_20","500","20"},  //insulto a civil
        {"STR_Crime_21","500","21"},  //insulto a autoridade
        {"STR_Crime_22","2000","22"}, //trafico de drogas
        {"STR_Crime_23","5000","23"},  //invasao a reserva federal
        {"STR_Crime_24","10000","24"},  //matou um civil
        {"STR_Crime_25","20000","25"}  //matou um policia
    };
};
