...
[ 1 , "O teu carros esta entrege e assegurado!" ] RemoteExecCall [ "life_fnc_broadcast" , _unit];
}else{
[ 1 , "O teu carros esta entrege e nao assegurado!" ] RemoteExecCall [ "life_fnc_broadcast" , _unit];
};
serv_sv_use deleteAt _servIndex;
